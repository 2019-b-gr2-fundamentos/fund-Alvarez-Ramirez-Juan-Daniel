...
var funcion_adivinarletra_1 = require("./funcion-adivinarletra");
...
function juego(arrayDeArraysPalabra, indiceDeArrayPalabra, arrayAdivinacion, numeroDeIntentosActual, numeroDeIntentosTotal) {
    return __awaiter(this, void 0, void 0, function () {
        var yaNoQuedanTurnos, imagenAhorcado_1, nuevoArrayDeAdivinacion, numberImage, imagenAhorcado, palabraTerminada, adivinacionCorrecta;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    yaNoQuedanTurnos = numeroDeIntentosActual == 0;
                    if (yaNoQuedanTurnos) {
                        imagenAhorcado_1 = fs.readFileSync('./ahorcado_imagenes/6.txt', 'utf8');
                        console.log(imagenAhorcado_1);
                        console.log("perdiste despues de completar " + indiceDeArrayPalabra + " palabras");
                        return [2 /*return*/];
                    }
                    return [4 /*yield*/, funcion_adivinarletra_1.adivinaLetra(arrayDeArraysPalabra[indiceDeArrayPalabra], arrayAdivinacion)];
                case 1:
